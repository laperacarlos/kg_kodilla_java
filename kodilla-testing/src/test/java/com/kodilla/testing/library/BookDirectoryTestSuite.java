...
public class BookDirectoryTestSuite {
    ...
    @Test
    void testLibraryUserWith0Book() {
        //Given
        LibraryUser libraryUser = new LibraryUser("Mark", "Twain", "98475638222");
        BookLibrary listOfBooks = new BookLibrary(libraryDatabaseMock);
        ...
        //When
        List<Book> listOf0Books = listOfBooks.listBooksInHandsOf(libraryUser);
    ...
    void testLibraryUserWith1Book() {
        ...
        //When
        List<Book> listOf1Book = listOfBooks.listBooksInHandsOf(libraryUser);
    ...
    @Test
    void testLibraryUserWith5Books() {
        //Given
        LibraryUser libraryUser = new LibraryUser("Mark", "Twain", "98475638222");
        BookLibrary listOfBooks = new BookLibrary(libraryDatabaseMock);
        ...
        //When
        List<Book> listOf5Books = listOfBooks.listBooksInHandsOf(libraryUser);
